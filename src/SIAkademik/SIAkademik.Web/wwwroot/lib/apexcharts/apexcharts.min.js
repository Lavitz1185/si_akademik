...
!function(t, e) {
      ...
      , u = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                t.filter(function(t) {
                    var e = null;
                    e = d.isSafari() || d.isFirefox() || d.isIE() ? t.flood("black", n).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a) : t.flood("black", n).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a).merge(t.source),
                    t.blend(t.source, e)
                }),
      ...
      , g = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i, s, a, n, r) {
                ...
                i || (i = t.attr("pathFrom")),
                s || (s = t.attr("pathTo")),
                (i.indexOf("undefined") > -1 || i.indexOf("NaN") > -1) && (i = "M 0 ".concat(l.globals.gridHeight),
                a = 1),
        ...
        return s(t, [{
            ...
            value: function(t) {
                var e = t.d
                  ...
                  , x = void 0 === p ? 0 : p
                  , m = this.w;
                return null === f && (f = m.config.stroke.lineCap),
            ...
            value: function(t) {
                ...
                if (T.attr("id", "".concat(b, "-").concat(i)),
                T.attr("index", a),
                y && T.attr({
    ...
    var p = {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                "string" == typeof t.x) {
                    ...
                    n = s.globals.gridHeight - (parseInt(t.y) - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight) - parseInt(t.label.style.fontSize) - t.marker.size,
                ...
                t.map(function(t, a) {
                    if ("vertical" === t.label.orientation) {
                        ...
                        if (null !== r) {
                            ...
                            "top" === t.label.position ? r.setAttribute("y", parseInt(r.getAttribute("y")) + o.width) : r.setAttribute("y", parseInt(r.getAttribute("y")) - o.width);
                    ...
                    for (var h = function(t) {
                        ...
                        Array.isArray(n.config.markers.size) ? n.globals.markers.size[e] > 0 : n.config.markers.size > 0) {
                            ...
                            n.config.markers.discrete.map(function(t) {
                                t.seriesIndex === e && t.dataPointIndex === h && (u.pointStrokeColor = t.strokeColor,
            ...
            value: function(t, e, i) {
                ...
                h.x instanceof Array)
                    for (var m = 0; m < h.x.length; m++) {
                        ...
                        c !== 1 / 0 && (y = s.globals.seriesZ[l][b] / c,
                        ...
                        if (k = k || 0,
                        v = v || 0,
                        0 === (w = w || 0) && 0 === k || void 0 === s.globals.series[l][b])
                            return;
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                for (var l = function(r, l) {
                    var h, c, d, u, g = void 0, f = void 0, p = void 0, x = void 0, m = [], b = [], v = s.globals.comboCharts ? e[r] : r, y = a.group({
            ...
            value: function(t) {
                ...
                this.setSelectedBarFilter(k, e, a),
                h.add(k);
            ...
            value: function(t) {
                ...
                if (a = a + u.line(y.newX, b) + y.path + u.line(r, b + i - s) + u.line(r, b),
            ...
            value: function(t) {
                ...
                var v = {
                  ...
                  , y = this.barEndingShape(d, v, this.series, g, p);
                if (n = n + u.line(b, y.newY) + y.path + u.line(b + o - h, l) + u.line(b, l),
      ...
      , M = function(t) {
        ...
        s(i, [{
            ...
            key: "drawBarPaths",
            value: function(t) {
                for (var e, i = t.indexes, s = t.barHeight, a = t.strokeWidth, n = t.pathTo, r = t.pathFrom, o = t.zeroW, l = t.x, h = t.y, c = t.yDivision, d = t.elSeries, u = this.w, g = h, f = i.i, p = i.j, x = i.realIndex, m = i.bc, b = 0, v = 0; v < this.prevXF.length; v++)
                    b += this.prevXF[v][p];
                if (f > 0) {
                    var y = o;
                    this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + b : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - b),
                    e = y
                } else
                    e = o;
            ...
            value: function(t) {
                ...
                if (this.series.length > 1 && u !== this.endingShapeOnSeriesNumber && (A.path = this.graphics.line(b + o - h, A.newY)),
                ...
                n = n + this.graphics.line(b, A.newY) + A.path + this.graphics.line(b + o - h, m) + this.graphics.line(b, m),
                r = r + this.graphics.line(b, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b, m),
      ...
      , P = function(t) {
        ...
        s(i, [{
            ...
            value: function(t, e) {
                ...
                l++) {
                    var h, c, d = void 0, u = void 0, g = void 0, p = void 0, x = [], m = [], b = i.globals.comboCharts ? e[o] : o, y = s.group({
            ...
            value: function(t) {
                ...
                void 0 === this.series[d][u] || null === this.series[d][u] ? k = o : (k = o - k / m,
                A = o - A / m,
                y = o - v.h / m,
                w = o - v.l / m),
        ...
        s(i, [{
            ...
            value: function(t) {
                ...
                for (var v = b ? t.series.length - 1 : 0; b ? v >= 0 : v < t.series.length; b ? v-- : v++) {
                    ...
                    z = Math.round(C * d.negToZero(e.globals.previousPaths[v]) / 100) + S),
                    Math.abs(L) + Math.abs(k) >= 360 && (L -= .01),
                    Math.abs(z) + Math.abs(S) >= 360 && (z -= .01);
                    var M = L - k
                    ...
                    var I = 0;
                    !X.initialAnim || e.globals.resized || e.globals.dataChanged || (I = (L - k) / 360 * e.config.chart.animations.speed,
                    this.animDur = I / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    e.globals.dataChanged && (I = (L - k) / 360 * e.config.chart.animations.dynamicAnimation.speed,
                    this.animDur = I / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    X.animatePaths(E, {
                        centerX: t.centerX,
      ...
      , O = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], m = [], b = 0, y = 0; y < t.length; y++) {
                    ...
                    for (var Z = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, $ = 0; $ < Z; $++) {
                        ...
                        s.config.chart.stacked ? (j = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? m[y - 1][$ + 1] : M,
            ...
            value: function(t) {
                ...
                if ("smooth" === m) {
                    var b = .35 * (a - r);
                    p.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (c = x.move(r, o) + x.curve(r + b, o, a - b, n, a + 1, n),
                    d = x.move(r + 1, o) + x.curve(r + b, o, a - b, n, a + 1, n) + x.line(a, h) + x.line(r, h) + "z") : (c = x.move(r, o),
                    d = x.move(r, o) + "z")),
                    u.push(c),
                    g.push(d)) : (c += x.curve(r + b, o, a - b, n, a, n),
                    ...
                    d += x.move(a, h)),
                    "stepline" === m ? (c = c + x.line(a, null, "H") + x.line(null, n, "V"),
                    d = d + x.line(a, null, "H") + x.line(null, n, "V")) : "straight" === m && (c += x.line(a, n),
                    d += x.line(a, n)),
            ...
            value: function(t, e) {
                ...
                if (i.config.yaxis[e].labels.show)
                    for (var u = l; u >= 0; u--) {
                        ...
                        0 !== i.config.yaxis[e].labels.rotate && x.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[e].labels.rotate, " ").concat(m.x, " ").concat(m.y, ")")),
                        c += h
                    }
            ...
            value: function() {
                ...
                if (e.config.xaxis.labels.show)
                    for (var d = 0; d <= c - 1; d++) {
                        ...
                        a.add(m),
                        i.addTspan(m, g, this.xaxisFontFamily);
                        var b = document.createElementNS(e.globals.svgNS, "title");
                        b.textContent = g,
                        m.node.appendChild(b),
                        n += t
                    }
                if (void 0 !== e.config.xaxis.title.text) {
                    var v = i.group({
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                var s = []
                  , a = i + 1;
                a < 2 ? a = 2 : a > 2 && (a -= 2);
                for (var n = (e - t) / a, r = Math.floor(d.log10(n)), o = Math.pow(10, r), l = parseInt(n / o) * o, h = l * Math.floor(t / l), c = l * Math.ceil(e / l), u = h; s.push(u),
                !((u += l) > c); )
                    ;
            ...
            value: function(t, e, i) {
                ...
                s.yAxisScale[t] = this.niceScale(e, i, n.tickAmount ? n.tickAmount : 6)) : s.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && s !== Number.MAX_SAFE_INTEGER) {
                    ...
                    t.maxY > 10 && (t.maxY = t.maxY + 5 * p / 100 + .6)
                }
            ...
            value: function() {
                ...
                if (m.length > 0)
                    for (var b = 0; b < m.length; b++) {
                        for (var v = t.globals.dom.baseEl.querySelectorAll(".apexcharts-scatter-series .apexcharts-series[data\\:realIndex='".concat(b, "'] circle")), y = [], w = 0; w < v.length; w++)
                            y.push({
      ...
      , _ = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                for (var x = o + 1, m = l, b = 0, v = 1; b < r; b++,
                v++) {
                        ...
                        if (e.config.chart.brush.autoScaleYaxis) {
                            ...
                            i.w.config.series.forEach(function(t) {
                                t.data.forEach(function(t) {
                                    t[0] <= s.xaxis.max && t[0] >= s.xaxis.min && (t[1] > n && null !== t[1] && (n = t[1]),
    ...
    var et, it, st = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                if (void 0 !== s.config.grid.column.colors && s.config.grid.column.colors.length > 0)
                    for (var u = s.globals.padHorizontal, g = s.globals.padHorizontal + s.globals.gridWidth / e, p = s.globals.gridHeight, x = 0, m = 0; x < e; x++,
                    m++) {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (c.contains("apexcharts-bar-area") || c.contains("apexcharts-candlestick-area")) {
                    ...
                    s.config.tooltip.followCursor ? s.config.plotOptions.bar.horizontal ? (o = b - g.left + 15,
                    l = m - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2,
        ...
        return s(t, [{
            ...
            value: function(t) {
                var e, i, s, a = t.e, n = t.opt, r = this.w, o = null, l = this.getElTooltip(), h = this.getElXCrosshairs(), c = "touchmove" === a.type ? a.touches[0].clientX : a.clientX, d = "touchmove" === a.type ? a.touches[0].clientY : a.clientY;
                this.clientY = d,
                this.clientX = c;
                ...
                if ("bar" === r.config.chart.type && this.isBarHorizontal && this.hasBars() && (u = !1),
                "mousemove" === a.type || "touchmove" === a.type) {
                    if (null !== h && h.classList.add("active"),
    ...
    function() {
        ...
        function s(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, m, b, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]), P = Math.abs(e[2]), E = e[3] % 360, T = e[4], X = e[5], Y = e[6], I = e[7], F = new SVG.Point(t), O = new SVG.Point(Y,I), D = [];
